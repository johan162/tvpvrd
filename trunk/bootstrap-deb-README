...
setup the initial build environment on a typical Debian/Ubuntu/Linux Mint type system.

The script has two principal parts
  
  1. It installs all packages necessary to do a full build

  2. It bootstraps the automake/autoconf build system
