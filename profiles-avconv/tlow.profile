#;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
# TLOW Profile Transcode strea with low quality (reducing file size)
...
#----------------------------------------------------------------------------
cmd_line=-i [INPUT] -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 500k [OUTPUT]
...
#----------------------------------------------------------------------------
cmd_line_2pass_1= -i [INPUT] -pass 1 -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 500k -f mp4 /dev/null
...
#----------------------------------------------------------------------------
cmd_line_2pass_2= -i [INPUT] -pass 2 -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 500k [OUTPUT]
