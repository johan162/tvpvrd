...
############################################################################
# ffmpeg - Settings for ffmpeg transcoding
...
# Example:
#  -pre libx264-slower -i [INPUT] -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 750k [OUTPUT].mp4
#----------------------------------------------------------------------------
cmd_line=-i [INPUT] -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 750k [OUTPUT]
...
# Example:
# -pre libx264-slower -i [INPUT] -pass 1 -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 750k -f mp4 /dev/null
#----------------------------------------------------------------------------
cmd_line_2pass_1=-pre libx264-slower -i [INPUT] -pass 1 -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 750k -f mp4 /dev/null
...
#   [OUTPUT] is replaced bwith the output file WITHOUT extension
# Example:
# -pre libx264-slower -i [INPUT] -pass 2 -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 750k [OUTPUT].mp4
#----------------------------------------------------------------------------
