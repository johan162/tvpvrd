...
#   [OUTPUT] is replaced with the output file WITHOUT extension
# Example:
# -i [INPUT] -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 750k [OUTPUT].mp4
#----------------------------------------------------------------------------
cmd_line=-pre libx264-veryslow -i [INPUT] -threads 0 -strict experimental -c:a aac -b:a 192k -b:v 1200k [OUTPUT]

#----------------------------------------------------------------------------
# COMMAND_LINE_2PASS_1 string
# Command line options passed to the transcoding program when doing 
# two pass enocding for the first pass.
#
# Before passed to the program the following substitutions are done:
#   [INPUT] is replaced with the input file
#   [OUTPUT] is replaced bwith the output file WITHOUT extension
# Example:
# -i [INPUT] -pass 1 -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 750k -f mp4 /dev/null
#----------------------------------------------------------------------------
cmd_line_2pass_1=-y -pre libx264-veryslow -i [INPUT] -pass 1 -threads 0 -strict experimental -c:a aac -b:a 192k -b:v 1200k -f mp4 /dev/null
...
#   [OUTPUT] is replaced bwith the output file WITHOUT extension
# Example:
# -i [INPUT] -pass 2 -threads 0 -strict experimental -c:a aac -b:a 128k -b:v 500k [OUTPUT].mp4
#----------------------------------------------------------------------------
cmd_line_2pass_2=-pre libx264-veryslow -i [INPUT] -pass 2 -threads 0 -strict experimental -c:a aac -b:a 192k -b:v 1200k [OUTPUT]
