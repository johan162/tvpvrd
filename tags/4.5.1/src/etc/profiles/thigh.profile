#;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
# THIGH Profile   Transcode with high quality
...
#
# Example:
#  -i [INPUT] -threads 0 -c:a aac -ab 192k -c:v libx264 -b:v 1200k -tune film -profile:v high -strict experimental -preset fast -tune film -profile:v main [OUTPUT]
#----------------------------------------------------------------------------
cmd_line=-i [INPUT] -threads 0 -c:a aac -ab 192k -c:v libx264 -b:v 1200k -tune film -profile:v high -strict experimental -preset fast -tune film -profile:v main [OUTPUT]
...
# Example:
# -y -i [INPUT] -pass 1 -threads 0 -tune film -profile:v high -strict experimental -c:a aac -b:a 192k -b:v 1200k -f mp4 /dev/null
#----------------------------------------------------------------------------
cmd_line_2pass_1=-y -i [INPUT] -pass 1 -threads 0 -tune film -profile:v high -strict experimental -c:a aac -b:a 192k -b:v 1200k -f mp4 /dev/null
...
#   [OUTPUT] is replaced with the output file 
# Example:
# -i [INPUT] -pass 2 -threads 0 -tune film -profile:v high -strict experimental -c:a aac -b:a 192k -b:v 1200k [OUTPUT]
#----------------------------------------------------------------------------
cmd_line_2pass_2=-i [INPUT] -pass 2 -threads 0 -tune film -profile:v high -strict experimental -c:a aac -b:a 192k -b:v 1200k [OUTPUT]
